...
Current strategy and execution addendum
→ reconstruction theory
→ [`CODEBASE.md`](../CODEBASE.md)
→ Codex executable status
→ quality evidence
...
- [`checklists/PHASE_GATE_SYSTEM.md`](checklists/PHASE_GATE_SYSTEM.md)
- [`reproducibility/2026-07-29-t0-validation.md`](reproducibility/2026-07-29-t0-validation.md)
- [`quality/README.md`](../quality/README.md)

Documents not listed here are not part of the active reading path unless an
authoritative file explicitly links them.
