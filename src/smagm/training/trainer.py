...
class T1CTrainer:
    ...
    def _structural_components(self, evidence: tuple[ContextEvidence, ...]) -> tuple[dict[str, torch.Tensor], dict[str, str]]:
    ...
    def _record_ledger_bindings(self, ledger: EpisodeLedger, assignment: EpisodeAssignment) -> None:
        ...
        self._last_manifest_hash = ledger._manifest.manifest_hash
        registry = getattr(ledger, "_split_registry", None)
        self._last_split_registry_hash = getattr(registry, "registry_hash", "")
    ...
    def train_step(
        ...
        *,
        ...
        active, inactive = self._structural_components(step.context_evidence)
        ...
        report = TrainStepReport(
            ...
            encoder_runtime_seconds=step.encoder_runtime_seconds,
    ...
    def checkpoint_state(self) -> dict[str, object]:
        ...
        return {
            "schema": "smagm-episodic-trainer-checkpoint-v2",
            "variant": self.encoder.config.variant,
